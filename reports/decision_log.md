...
14. Use an independent LLM judge and compare it with 40 blinded human scores. The final judge was Groq `openai/gpt-oss-20b`; agreement is reported rather than assumed.
15. Enforce evaluation integrity: refuse blank gold labels and hold out all 200 golden message IDs from both training and retrieval before final scoring.
